...
app.disable('x-powered-by') // Deshabilitar el header que dice la tecnología usada
...
app.get('/movies', (req, res) => {
  ...
  // if (ACCPETED_ORIGINS.includes(origin) || !origin) {
...
app.patch('/movies/:id', (req, res) => {
  ...
  // Revisar => Actualiza solo ciertos campos
  const updateMovie = {
    ...movies[movieIndex],
    ...result.data
  }
